...
#+RESULTS:
| t | TODO | entry | (file+headline /Users/andrew/org/agenda/gtd.org Tasks) | * TODO %? |
...
#+RESULTS:
: ((/INBOX . 105) (/sent . 115) (/trash . 116) (/all . 97))
...
** TODO [[Create list for globally enabled packages][Avy]]
